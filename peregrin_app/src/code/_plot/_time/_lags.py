...
from peregrin_app.src.code import Colors, Styles
...
#     def __init__(self, data: pd.DataFrame, *args, category: Tuple[List[Any], bool], c_mode: str, **kwargs):
#         """
#         Initialize MSD analyzer.
...
#                 if cond not in self.data['Condition'].unique():
#                     errorneous.append(cond)
#             if len(errorneous) > 0:
#                 self.noticequeue.Report(Level.error, f'Conditions {errorneous} not found in data.')
#                 return
#             else:
#                 pass
#         except Exception as e:
#             self.noticequeue.Report(Level.error, f"Error validating conditions.", str(e))

#     def filter_conditions(self) -> 'MSD2':
#         """
#         Filter data to specific conditions.
...
#         -------
#         MSD2
#             New MSD2 instance with filtered data
#         """
#         filtered = self.data[self.data['Condition'].isin(self.cond)]
#         return MSD2(filtered, self.color_map)
    
#     def aggregate_replicates(self) -> 'MSD2':
#         """
#         Aggregate data across replicates by condition and frame lag.
...
#         -------
#         MSD2
#             New MSD2 instance with aggregated data
#         """
#         agg_dict = {
#             'MSD mean': 'mean',
#             'MSD sem': 'sem',
...
#         }
#         aggregated = self.data.groupby(['Condition', 'Frame lag']).agg(agg_dict).reset_index()
#         return MSD2(aggregated, self.color_map)

#     def categorize(self) -> 'MSD2':
#         """
#         Categorize data based on condition and replicate selections.
#         """


#         elif self.cond != 'all' and self.rep == ''
