...
def MountTracks(input, output, session, S, noticequeue):
    ...
    def tracks_lutmap_auto_scale_info():
        if (S.SPOTSTATS.get() is None or S.SPOTSTATS.get().empty
...
#     def __call__(self, input, output, session, S, noticequeue):
#         self.LutMap(input, output, session, S)
#         self.realistic_reconstruction(input, output, session, S, noticequeue)
#         self.polar_reconstruction(input, output, session, S, noticequeue)
#         self.LutMap(input, output, session, S)
#         self.animated_reconstruction(input, output, session, S, noticequeue)